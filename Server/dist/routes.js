...
function setRoutes(app) {
  ...
  router.route('/users').get(_passport["default"].authenticate, _users["default"].getAll);
  router.route('/user/:id').get(_passport["default"].authenticate, _users["default"].getById);
